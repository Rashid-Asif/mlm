...
class CI_Typography {
	...
	var $inline_elements = 'a|abbr|acronym|b|bdo|big|br|button|cite|code|del|dfn|em|i|images|ins|input|label|map|kbd|q|samp|select|small|span|strong|sub|sup|textarea|tt|var';
