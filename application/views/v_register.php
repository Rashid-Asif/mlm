        ...
        <div class="row">
            <div class="cell-12">
                ...
                <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                    <span class="bold">You Are In:</span><a href="#">Home</a><span class="line-separate">/</span><span>Create account</span>
                </div>
            </div>
        </div>
    </div>
...
<div class="form-input">
    <label>PIN Code<span class="red">*</span></label><input type="password" required>
</div>
<div class="form-input">
    <label>Referral Code</label><input type="password">
</div>
<div class="form-input">
    <label>Select Hand</label>
    <div class="form-box">
        <input type="radio" name="Gender" value="Left" /> <span>Left</span>
        <input type="radio" name="Gender" value="Right" /> <span>Right</span>
    </div>
</div>
<div class="form-input">
...
<option value="Africa">Central African Republic</option>
...
<option value="Croatia">Croatia, Republic of</option>
...
<option value="Kenya">Kenya Coast Republic</option>
...
<option value="Not in list">other</option>
</select>
</div>
<div class="form-input">
    <label>Gender</label>
